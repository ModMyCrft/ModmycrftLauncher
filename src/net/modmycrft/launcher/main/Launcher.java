...
public class Launcher {
	private LauncherDiscordRPC launcherRPC = new LauncherDiscordRPC();
	...
	public void startRPC() {
		this.launcherRPC.start();
	}
	
	public void updateDiscordRPCThread() {
		this.launcherRPC = new LauncherDiscordRPC();
	}
	...
	public void shutdownRPC() {
		this.launcherRPC.shutdownThread();
	}
	...
	public static HashMap<String, Object> getOptionsFromFile() {
		File optionsFile = new File("Options.launcher");
			...
			javaArgs = property.getProperty("JavaArgs", "-Djava.util.Arrays.useLegacyMergeSort=true -Dhttp.proxyHost=betacraft.uk -Dhttp.proxyPort=11702");
	...
	public void clientConsole(Process proc) {
		...
		Gui gui = new Gui();
		gui.displayConsole(stdInput, stdError, proc);
	}
}
