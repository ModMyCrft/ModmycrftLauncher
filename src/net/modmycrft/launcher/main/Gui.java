	...
	private void initGui() throws IOException {
	    ...
	    butt5.addActionListener(new ActionListener(){  
			...
			public void actionPerformed(ActionEvent e) {
				...
				butt6.setBounds(65,200,150, 40);
				servModeChBox.setBounds(22,10,100, 20);
				label5.setBounds(96,130,400, 20);
				label6.setBounds(96,40,400, 20);
				label7.setBounds(156,100,400, 20);
				label8.setBounds(156,70,400, 20);
				serverMaxPlayersField.setBounds(26, 40, 60, 20);
				serverIPField.setBounds(26, 70, 120, 20);
				serverLevelNameField.setBounds(26, 100, 120, 20);
				serverPortField.setBounds(26, 130, 60, 20);
				frameOptions.setSize(300,300);
